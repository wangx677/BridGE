function genstats_geneset_of_interest(genes,ssmFile,snpgenemapping,outputname,binaryNetwork,snpPerms,minPath,netDensity)
...
BPM.path1 = repmat(outputname,length(BPM.ind1),1);
BPM.path2 = [outputname; WPM.pathway];
...
outputFile = sprintf('genstats_%s_%s',outputname,ssmFile);
